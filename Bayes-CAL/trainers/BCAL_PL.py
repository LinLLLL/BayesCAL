...
class BCAL_PL(TrainerX):
    """Context Optimization (BCAL_PL).
    """

    def check_cfg(self, cfg):
        assert cfg.TRAINER.BCAL_PL.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.BCAL_PL.PREC == "fp32" or cfg.TRAINER.BCAL_PL.PREC == "amp":
        ...
        self.scaler = GradScaler() if cfg.TRAINER.BCAL_PL.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        # print(image.shape)
        prec = self.cfg.TRAINER.BCAL_PL.PREC
        if prec == "amp":
            with autocast():
