    ...
    for idx, (im, label) in enumerate(train_mnist):
      ...
      if idx < 20000:
        ...
        if np.random.uniform() < 0.9:
          color_red_test = not color_red
        np.random.seed(0)
        if np.random.uniform() < 0.9:
          color_red_val = not color_red
      ...
      if idx < 20000:
        ...
        colored_arr = color_grayscale_arr(im_array, red=color_red_test)
        test_set.append((Image.fromarray(colored_arr), binary_label))

        colored_arr = color_grayscale_arr(im_array, red=color_red_val)
...
if __name__ == "__main__":
    colored_mnist = ColoredMNIST(root='/home/liulei/DG/DATA', env='train1',
                                 transform=transforms.Compose([transforms.ToTensor(),
                                                               transforms.Normalize((0.1307, 0.1307, 0.),
